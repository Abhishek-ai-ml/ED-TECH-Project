  ...
  return (
    <div>
        ...
        <section className='bg-richblack-800 flex flex-col items-center relative gap-y-5 pt-16'>
            ...
            <header className='font-semibold text-4xl text-richblack-5 font-inter w-[809px] text-center'>
                Driving Innovation in Online Education for a 
                <HighlightText text={"Brighter Future"}/> 
            </header>

            <p className='text-richblack-300 font-medium text-base w-[809px] text-center pb-[200px]'>
                Studynotion is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.
            </p>

            <div className='flex gap-x-5 absolute top-32 pt-[220px]'>
        ...
        {/* Section 2 */}
        <section className='bg-richblack-900 flex justify-center w-[1200px] pt-[250px] mx-auto pb-[100px]'>
        ...
        {/* Section 3 */}
        <section className='flex w-11/12  mx-auto justify-between gap-x-32 pb-[150px] pt-[100px]'>
            <div className='w-[50%] flex flex-col pl-20 gap-y-5'>
            ...
            <div className='w-[50%] flex place-items-end ml-20'>
                <img src={Image4}/>
            </div>
        </section>

        {/* Section 4 */}
        <section className='flex w-11/12  mx-auto justify-between gap-x-32 pb-[150px] pt-[50px]'>
            <div className='w-[50%] flex flex-col pl-20 gap-y-5'>
