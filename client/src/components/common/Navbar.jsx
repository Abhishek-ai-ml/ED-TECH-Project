...
function Navbar() {
  ...
  return (
    <div
      className={`w-full flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 ${
        location.pathname !== "/" ? "bg-richblack-900" : ""
      } transition-all duration-200 fixed left-0 right-0 z-30 bg-richblack-900`}
    >
